...
#logo = logomaker.Logo(iupac_mat,negate=False, colors='RdBu')
#logo = logomaker.Logo(iupac_mat,negate=False,colors=(0.1,0.3,0.5))
...
#logo = logomaker.Logo(random_df,negate=-1)
