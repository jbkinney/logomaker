...
# # Information logo
# class FreqLogo(Logo):
#     def __init__(self, mat, mat_type='freq_mat', background=None, **kwargs):
#
#         # Transform input mat to freq_mat
#         freq_mat = data.transform_mat(mat, from_type=mat_type, to_type='freq_mat', background=background)
#
#         # Change default plot settings
...
#         Logo.__init__(self, mat=freq_mat, **kwargs)
#
# # Information logo
# class InfoLogo(Logo):
#     def __init__(self, mat, mat_type='freq_mat', background=None, **kwargs):
#
#         # Transform input mat to info_mat
#         info_mat = data.transform_mat(mat, from_type=mat_type, to_type='info_mat', background=background)
#
#         # Get max info value
#         self.max_info = max(info_mat.values.sum(axis=1))
#
#         # Change default plot settings
#         if (not 'ylim' in kwargs) and (background is None):
#             num_chars = info_mat.shape[1]
#             ymax = np.log2(num_chars)
#             kwargs['ylim'] = [0, ymax]
#
#         if not 'ylabel' in kwargs:
#             kwargs['ylabel'] = 'information\n(bits)'
#
#         # Run base class constructor
#         Logo.__init__(self, mat=info_mat, **kwargs)
#
# # Weight logo
# class WeightLogo(Logo):
#     def __init__(self, mat, mat_type='weight_mat', background=None, **kwargs):
#
#         # Transform input mat to weight_mat
#         weight_mat = data.transform_mat(mat, from_type=mat_type, to_type='weight_mat', background=background)
#
#         # Change default plot settings
#         if not 'ylabel' in kwargs:
#             kwargs['ylabel'] = 'score'
#
#         # Run base class constructor
#         Logo.__init__(self, mat=weight_mat, **kwargs)
#
# # Weight logo
# class EnergyLogo(Logo):
#     def __init__(self, mat, mat_type='energy_mat', background=None, **kwargs):
#
#         # Transform input mat to weight_mat
#         energy_mat = data.transform_mat(mat, from_type=mat_type, to_type='energy_mat', background=background)
#
#         # Change default plot settings
#         if not 'ylabel' in kwargs:
#             kwargs['ylabel'] = '- energy\n($k_B T$)'
#
#         # Run base class constructor
#         Logo.__init__(self, mat=energy_mat, **kwargs)